...
public class ViewPagerTabHost extends BaseTabHost{
	...
	public FrameLayout getTabContentView() {
        if (mViewPager != null && mViewPager.getParent() != null){
            return (FrameLayout) mViewPager.getParent();
        }
	...
	protected void dispatchTabChanged(String tabId) {
		super.dispatchTabChanged(tabId);
		 ...
		 mViewPager.setCurrentItem(position, isShowAnimation);
	}
...
//		mOnTabChangeListener = l;
	...
	public static interface IOnTabChangedListener {
		public void onTabChanged(String newTabID, String oldTabID);
	}
	
	public void setTabChangedListener(IOnTabChangedListener l) {
		mOnTabChangeListener = l;
	} 
	...
	private class InteriorPagerAdapter extends AbsPagerTabHostAdapter{
		...
		private void setupTabWidget(AbsPagerTabHostAdapter adapter){
			if(mTabHost == null || adapter == null){
				return;
			}
			
			if(mTabHost.getTabWidget().getTabCount() == adapter.getCount()){
				return;
			}
		...
		public void setPrimaryItem(ViewGroup container, int position,
			...
			if(mAdapter != null){
				...
				if(mOnTabChangeListener != null && position != mOldPosition){
					mOnTabChangeListener.onTabChanged(mAdapter.getTab(position), mOldPosition < 0 ? null : mAdapter.getTab(mOldPosition));
				}
...
//		LogUtil.e("ViewPagerTabHost", "onTouchEvent");
		return super.onTouchEvent(event);
	}
	
	@Override
	public boolean dispatchTouchEvent(MotionEvent ev) {
//		LogUtil.e("ViewPagerTabHost", "dispatchTouchEvent");
		return super.dispatchTouchEvent(ev);
	}
	
	@Override
	public boolean onInterceptTouchEvent(MotionEvent ev) {
//		LogUtil.e("ViewPagerTabHost", "onInterceptTouchEvent");
		if(mScrollChild != null){
			return mScrollChild.isChildScroll(ev);
		}
	...
	public void setScrollChild(ScrollChild mScrollChild){
