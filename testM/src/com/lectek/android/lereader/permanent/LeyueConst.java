...
//	public static final boolean IS_OUT_LOG = true;
	...
	/**微信平台下载乐阅的应用宝地址：*/
	public static final String WX_YYB_PATH = ApiConfig.URL+"/views/web/bookDetail.html?bookId=";
	/**微信appid*/
	...
	/**下订单--来源 --天翼阅读-1*/
	public static final String SOURCE_TYPE_TY = "1";
	/**下订单--来源 --中信-2*/
	public static final String SOURCE_TYPE_ZHONG_XIN = "2";
	
    /** 数据来源，用于服务端区分乐阅数据 与 微信 数据**/
	...
	public static int pageLoadingPageSize = Integer.MAX_VALUE;
	
	public static int pageLoadingPageItemSize = 20;
