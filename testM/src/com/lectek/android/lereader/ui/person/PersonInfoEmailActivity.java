...
import com.lectek.android.lereader.binding.model.user.PersonInfoEmailViewModel;
import com.lectek.android.lereader.binding.model.user.PersonInfoNickNameViewModel;
import com.lectek.android.lereader.binding.model.user.PersonInfoEmailViewModel.UserAction;
...
public class PersonInfoEmailActivity extends BaseActivity {
	...
	private final String PAGE_NAME = "我的资料-修改邮箱界面";
	
	private PersonInfoEmailViewModel mMyInfoViewModel;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitleContent(getString(R.string.person_info_modify_email));
	}
	...
	protected View newContentView(Bundle savedInstanceState) {
		mMyInfoViewModel = new PersonInfoEmailViewModel(this, this);
		mMyInfoViewModel.onStart();
		mMyInfoViewModel.setUserAction(new UserAction() {
			
			@Override
			public void modifyUserInfo() {
				PersonInfoEmailActivity.this.setResult(PersonInfoNickNameViewModel.RESULT_CODE_MODIFIED);
				PersonInfoEmailActivity.this.finish();
			}
		});
...
//	}
	...
	public void finish() {
		...
		if(isModified){
			PersonInfoEmailActivity.this.setResult(PersonInfoActivity.RESULT_CODE_MODIFIED);
		}
		super.finish();
	}
