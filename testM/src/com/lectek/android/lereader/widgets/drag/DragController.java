...
public class DragController {
	 ...
	 * @param event
	 */
	public void notifyDragCreated(int page, IDragItemView itemView,
			MotionEvent event) {
	 ...
	 * 通知文件创建或更新
	 * 
	 * @param fileDataPosition
	 * @param itemDataPosition
	 */
	public void notifyFileCreateOrUpdate(int fileDataPosition, int itemDataPosition) {
		for (IDragListener listener : mControllerList) {
			listener.onFileCreateOrUpdate(fileDataPosition, itemDataPosition);
		}
	}
